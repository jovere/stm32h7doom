...
void HardFault_Handler(void)
{
  ...
  printf("\n=== HARD FAULT ===\n");
  printf("CFSR (Configurable Fault Status Register): 0x%08lX\n", cfsr);
  printf("HFSR (HardFault Status Register): 0x%08lX\n", hfsr);
  printf("DFSR (Debug Fault Status Register): 0x%08lX\n", dfsr);
  printf("AFSR (Auxiliary Fault Status Register): 0x%08lX\n", afsr);
  printf("MMFAR (MemManage Fault Address): 0x%08lX\n", mmar);
  printf("BFAR (Bus Fault Address): 0x%08lX\n", bfar);
